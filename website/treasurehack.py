...
model = pickle.load(open("/Users/dhruvbejugam/Desktop/Water-Classification-System-main/machine-learning-model/water.pkl", "rb"))
barwater = Image.open("/Users/dhruvbejugam/Desktop/Water-Classification-System-main/website/Water Classifier Model.png")
st.image(barwater)
...
def about():
    st.title("About Us")   
    st.text("""Nik and Dhruv are 2 highschoolers who working to be innovative entrepreuners and
...
with an organization to scale this functional solution to this important problem.""")
